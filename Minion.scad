...
// From http://en.wikipedia.org/wiki/List_of_most_common_surnames_in_North_America
numLastNames=101;
...
"Perry", "Butler", "Barnes", "Fisher", "Popkin"];
// from Read more at http://names.mongabay.com/male_names.htm
numFirstNames = 301;
...
"Nicholas", "Roy", "Benjamin", "Bruce", "Brandon", "Adam", "Harry", "Fred", "Wayne", "Billy",
...
"Mike", "Stanley", "Leonard", "Nathan", "Dale", "Manuel", "Rodney", "Curtis", "Norman", "Allen",
"Marvin", "Vincent", "Glenn", "Jeffery", "Travis", "Jeff", "Chad", "Jacob", "Lee", "Melvin",
"Alfred", "Kyle", "Francis", "Bradley", "Jesus", "Herbert", "Frederick", "Ray", "Joel", "Edwin",
"Don", "Eddie", "Ricky", "Troy", "Randall", "Barry", "Alexander", "Bernard", "Mario", "Leroy",
...
"Armando", "Felix", "Jimmie", "Everett", "Jordan", "Ian", "Wallace", "Ken", "Bob", "Jaime",
"Casey", "Alfredo", "Alberto", "Dave", "Ivan", "Johnnie", "Sidney", "Byron", "Julian", "Isaac",
...
"Enrique", "Freddie", "Wade", "Laird"];
// What's your minion's name?
firstNum = floor(rands(1,numFirstNames+1,1,seed[0])[0]);
secondNum = floor(rands(1,numLastNames+1,1,seed[0])[0]);
//echo("name ",firstNum,secondNum);
...
module base() {
	...
	color("black") translate([.75*width,0,0]) rotate([0,0,90]) scale([2,4,2]) write(minionName,center=true);
